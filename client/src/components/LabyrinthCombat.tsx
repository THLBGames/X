...
interface LabyrinthCombatProps {
  ...
  preparedCombatData?: any; // Combat data from the prepared event
}

export default function LabyrinthCombat({ labyrinthClient, preparedCombatData }: LabyrinthCombatProps) {
